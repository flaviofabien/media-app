...
import ContentsConsultation1 from '../Ui/Contents/Consulations$/ContentsConsultation1'
...
export default function ModalConsultation({consultation,isExpanded,setExpandedItems,setModalConsultation}: Props) {
  return (
    <div className='fixed top-0 left-0 bg-black bg-opacity-30 w-full h-screen flex flex-row justify-center items-center'>
                    <div className=' max-w-[900px] lg:items-start rounded-lg  shadow-xl text-center    bg-yellow-400   '>
                        ...
                        <div className=' p-4 w-full text-start -mb-4'>
                            <ContentsConsultation1 k={consultation.id} isExpanded={isExpanded}  setExpandedItems={setExpandedItems} historique={consultation.historique} dateConsultation={consultation.dateConsultation} refereAutoRefere={consultation.refereAutoRefere} motif={consultation.motif} signePhysique={consultation.signePhysique}   />
                        </div>
